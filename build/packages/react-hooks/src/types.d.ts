...
export declare type TxDef = [string, unknown[] | ((...params: unknown[]) => SubmittableExtrinsic<'promise'>)];
export declare type TxDefs = SubmittableExtrinsic<'promise'> | IExtrinsic | Call | TxDef | null;
export declare type TxSource<T extends TxDefs> = [T, boolean];
export declare type CollectiveType = 'council' | 'membership' | 'technicalCommittee';
...
export declare type UseJudgements = Judgement[];
export declare type BatchType = 'all' | 'default';
