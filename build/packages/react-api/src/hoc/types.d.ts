...
export declare type StorageTransform = (input: any, index: number) => unknown | null;
export declare type HOC = (Component: React.ComponentType<unknown>, defaultProps?: DefaultProps, render?: RenderFn) => React.ComponentType<unknown>;
