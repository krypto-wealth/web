...
export declare class BountiesPage {
    ...
    renderOne(bounty: PalletBountiesBounty, proposals?: DeriveCollectiveProposal[], description?: string, index?: BountyIndex): RenderedBountiesPage;
    ...
    expectVotingDescription(description: string): Promise<void>;
}
export {};
