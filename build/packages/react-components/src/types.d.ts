...
export declare type FlagColor = 'blue' | 'green' | 'grey' | 'orange' | 'pink' | 'red' | 'yellow' | 'theme';
export declare type AccountIdIsh = AccountId | AccountIndex | Address | string | Uint8Array | null;
export declare type DisplayedJudgement = 'Erroneous' | 'Low quality' | 'Known good' | 'Reasonable';
export {};
