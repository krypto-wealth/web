...
declare const _default: {
    ...
    Line: import("react").MemoExoticComponent<({ className, colors, labels, legends, options, values }: import("./types").LineProps) => import("react").ReactElement<import("./types").LineProps, string | import("react").JSXElementConstructor<any>> | null>;
};
