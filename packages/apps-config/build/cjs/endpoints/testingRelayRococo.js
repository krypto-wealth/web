...
exports.testRelayRococo = exports.testParasRococoCommon = exports.testParasRococo = void 0;
...
const testParasRococo = [{
  info: 'arctic',
  isUnreachable: true,
  // https://github.com/polkadot-js/apps/issues/7420
  paraId: 3025,
  text: 'Arctic',
  providers: {
  ...
  info: 'rococoBajun',
  isUnreachable: true,
  // https://github.com/polkadot-js/apps/issues/7593
  paraId: 3026,
  text: 'Bajun Network',
  providers: {
  ...
  info: 'rococoMoonsama',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7526
  paraId: 2055,
  text: 'Moonsama',
  providers: {
  ...
  isDisabled: true,
  // See https://github.com/polkadot-js/apps/issues/5842
  paraId: 2050,
  text: 'Zeitgeist PC',
  providers: {
...
exports.testParasRococo = testParasRococo;
const testParasRococoCommon = [{
...
exports.testParasRococoCommon = testParasRococoCommon;
const testRelayRococo = {
  dnslink: 'rococo',
  genesisHash: _constants.ROCOCO_GENESIS,
  info: 'rococo',
  text: 'Rococo',
  providers: {
  ...
  teleport: [1000, 1002],
  linked: [...testParasRococoCommon, ...testParasRococo]
};
exports.testRelayRococo = testRelayRococo;