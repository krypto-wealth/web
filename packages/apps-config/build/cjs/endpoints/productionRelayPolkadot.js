...
const prodParasPolkadot = [{
  ...
  paraId: 2015,
  text: 'Manta',
  providers: {// 'Manta Kuhlii': 'wss://kuhlii.manta.systems', // https://github.com/polkadot-js/apps/issues/6930
  ...
  paraId: 2040,
  text: 'Polkadex',
  providers: {// 'Polkadex Team': 'wss://mainnet.polkadex.trade/', // https://github.com/polkadot-js/apps/issues/7620
...
exports.prodParasPolkadot = prodParasPolkadot;
...
exports.prodParasPolkadotCommon = prodParasPolkadotCommon;
const prodRelayPolkadot = {
  dnslink: 'polkadot',
  genesisHash: _constants.POLKADOT_GENESIS,
  info: 'polkadot',
  text: 'Polkadot',
  providers: {
...
exports.prodRelayPolkadot = prodRelayPolkadot;