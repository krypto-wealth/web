...
const testChains = [{
  ...
  info: 'kwe',
  text: 'Kwe Zero Testnet',
  providers: {
    'Kwe Zero Foundation': 'wss://ws.test.azero.dev'
  }
}, {
  info: 'nodle',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7652
  text: 'Arcadia',
  providers: {
  ...
  info: 'clover',
  isDisabled: true,
  // Cannot construct unknown type BridgeNetworks
  text: 'Clover',
  providers: {
  ...
  info: 'coinversation',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6635
  text: 'Coinversation',
  providers: {
  ...
  providers: {
    ...
    'DCloud Foundation': 'wss://api.decloudf.com/' // Pinknode: 'wss://rpc.pinknode.io/maxwell/explorer' // https://github.com/polkadot-js/apps/issues/7058
  ...
  info: 'dock-testnet',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6831
  text: 'Dock',
  providers: {
  ...
  info: 'dolphin',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7439
  ...
  info: 'equilibrium',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6250
  text: 'Equilibrium',
  providers: {
  ...
  info: 'substrate',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/5571
  text: 'Flaming Fir',
  providers: {
  ...
  info: 'fantour',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6519
  text: 'Fantour',
  providers: {
  ...
  info: 'Galital',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6721
  text: 'Galital PC2',
  providers: {
  ...
  info: 'gamepower',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7223
  text: 'GamePower',
  providers: {
  ...
  info: 'halongbay',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6871
  ...
  info: 'ipse',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6242
  text: 'IPSE',
  providers: {
  ...
  info: 'khala',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6930
  text: 'Khala (Para 3)',
  providers: {
  ...
  info: 'manta',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6384
  text: 'Manta Testnet',
  providers: {
  ...
  providers: {
    ...
    OnFinality: 'wss://moonbeam-alpha.api.onfinality.io/public-ws' // Pinknode: 'wss://rpc.pinknode.io/alphanet/explorer' // https://github.com/polkadot-js/apps/issues/7058

  }
}, {
  info: 'mybank',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/5845
  text: 'mybank.network',
  providers: {
  ...
  info: 'opal',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7638
  text: 'OPAL by UNIQUE',
  providers: {
  ...
  info: 'phoenix',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/6181
  ...
  info: 'pichiu',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/pull/6761
  text: 'Pichiu Testnet',
  providers: {
  ...
  info: 'prism',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7340
  text: 'Prism',
  providers: {
  ...
  info: 'subdao',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7473
  text: 'SubDAO Staging',
  providers: {
  ...
  info: 'unique',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7621
  text: 'Unique',
  providers: {
  ...
  info: 'unitv',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/5684
  text: 'Unit Network',
  providers: {
  ...
  info: 'zCloak',
  isDisabled: true,
  // https://github.com/polkadot-js/apps/issues/7408
  text: 'zCloak-network',
  providers: {
