...
const definitions = {
  types: [{
    ...
    types: {
      ...
      EstimatesState: {
        _enum: ['InActive', 'Active', 'WaitingPayout', 'Completed']
      },
      EstimatesType: {
        _enum: ['DEVIATION', 'RANGE']
      },
      FractionLength: 'u32',
      HttpError: {
        _enum: {
      ...
      PurchaseId: 'Vec<u8>',
      Releases: {
        _enum: ['V1_0_0_Ancestral', 'V1_0_1_HttpErrUpgrade', 'V1_1_0_HttpErrUpgrade', 'V1_2_0']
      },
      RequestInterval: 'u8',
      StatusErr: '(u16)',
