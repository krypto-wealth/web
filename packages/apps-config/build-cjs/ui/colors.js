...
exports.specColors = exports.nodeColors = exports.emptyColor = exports.chainColors = void 0;

var _basiliskRococoBg = _interopRequireDefault(require("./logos/nodes/basilisk-rococo-bg.png"));
...
const chainBasiliskTestnet = `url(${String(_basiliskRococoBg.default)}) #000`;
...
const chainWestlake = 'linear-gradient(-90deg, #9400D3 0%, #5A5CA9 50%, #00BFFF 100%)'; // based on node name
// alphabetical
...
const nodeZCloak = 'linear-gradient(to right, #E89A76 0%, #C5B8CC 50%, #B0B4D7 100%)'; // based on the spec name
...
const chainColors = Object.entries({
  Acala: chainAcala,
  ...
  let [chain, color] = _ref;
  return { ...colors,
    [(0, _util.sanitize)(chain)]: color
  };
}, {}); // Alphabetical overrides based on the actual software node type
// NOTE: This is as retrieved via the system.name RPC

exports.chainColors = chainColors;
const nodeColors = Object.entries({
  ...
  let [node, color] = _ref2;
  return { ...colors,
    [(0, _util.sanitize)(node)]: color
  };
}, {}); // Alphabetical overrides based on the actual software node type
// NOTE: This is as retrieved via the system.name RPC

exports.nodeColors = nodeColors;
const specColors = Object.entries({
  shell: specShell,
  statemine: specStatemine,
  statemint: specStatemint,
  westmint: specWestmint
}).reduce((colors, _ref3) => {
  let [spec, color] = _ref3;
  return { ...colors,
    [(0, _util.sanitize)(spec)]: color
  };
}, {});
