...
const testParasWestend = [{
  info: 'basilisk',
  isUnreachable: true,
  // https://github.com/polkadot-js/apps/issues/6422
  paraId: 2097,
  text: 'Basilisk Egg',
  providers: {
  ...
  info: 'interlay',
  isUnreachable: true,
  // https://github.com/polkadot-js/apps/issues/6261
  paraId: 2094,
  text: 'Interlay',
  providers: {
  ...
  info: 'pangoro',
  isUnreachable: true,
  // https://github.com/polkadot-js/apps/issues/6530
  ...
  info: 'karura',
  isUnreachable: true,
  // https://github.com/polkadot-js/apps/issues/5830
  paraId: 2005,
  text: 'Wendala',
  providers: {
...
exports.testParasWestend = testParasWestend;
const testParasWestendCommon = [{
  info: 'westmint',
  paraId: 1000,
  text: 'Westmint',
  providers: {
...
exports.testParasWestendCommon = testParasWestendCommon;
const testRelayWestend = {
  dnslink: 'westend',
  genesisHash: _constants.WESTEND_GENESIS,
  info: 'westend',
  text: 'Westend',
  providers: {
  ...
  teleport: [1000],
  linked: [...testParasWestendCommon, ...testParasWestend]
};
exports.testRelayWestend = testRelayWestend;