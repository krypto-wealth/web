...
const prodParasKusama = [{
  ...
  providers: {
    ...
    OnFinality: 'wss://moonriver.api.onfinality.io/public-ws' // Pinknode: 'wss://rpc.pinknode.io/moonriver/explorer' // https://github.com/polkadot-js/apps/issues/7058
...
exports.prodParasKusama = prodParasKusama;
...
exports.prodParasKusamaCommon = prodParasKusamaCommon;
const prodRelayKusama = {
  dnslink: 'kusama',
  genesisHash: _constants.KUSAMA_GENESIS,
  info: 'kusama',
  text: 'Kusama',
  providers: {
...
exports.prodRelayKusama = prodRelayKusama;